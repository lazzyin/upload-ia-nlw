...
export function App() {
  ...
  const {
    input, setInput, handleInputChange, handleSubmit,
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          <div className="grid grid-rows-2 gap-4 flex-1">
            <Textarea value={input} onChange={handleInputChange} placeholder="Inclua o prompt para a IA" className="resize-none p-5 leading-relaxed"/>
            
            <Textarea value={completion} placeholder="Resultado gerado pela ia" readOnly className="resize-none p-5 leading-relaxed"/>
          </div>
